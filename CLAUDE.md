...
- `TemporalDirectivityResult` — window_sizes, times_by_window, ratios_by_window, n_totals_by_window, ci_lower/upper_by_window
- `MigrationAnalysisResult` — temporal_analysis, spatial_analysis, directional_analysis, magnitude_analysis

## Key Features Added 2026-05-08

1. **Temporal sliding ratio analysis** (`--temporal-ratio`) — N2/N1 ratio evolution with multi-window comparison
...
- `python main.py -i data/... --temporal-ratio` — adds 3 more plots
